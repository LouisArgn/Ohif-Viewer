...
class ToolbarRow extends Component {
  ...
  updateButtonGroups() {
    ...
    this.buttonGroups.back.unshift({
      value: 'Back',
      icon: 'angle-left',
      bottomLabel: this.props.t('Back'),
    });
    this.buttonGroups.analyze.unshift({
      value: 'Analyze',
      icon: 'search-plus',
      bottomLabel: this.props.t('Analyze'),
    });
  }
        ...
        <div className="ToolbarRow">
          <div>
            <div className="pull-left m-t-1 p-y-1" style={{ padding: '10px' }}>
              <RoundedButtonGroup
                options={this.buttonGroups.back}
                value={'test'}
                onValueChanged={() => {
                  window.location.href = this.props.appConfig.routerBasename;
